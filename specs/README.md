...
| [ruststack-lambda-squib-runtime-design](./ruststack-lambda-squib-runtime-design.md) | Design | Draft | Squib microVM Lambda executor -- explicit `LAMBDA_EXECUTOR=squib`, local Squib 0.2.0 path dependency, bounded vsock stage-and-invoke protocol, arm64 Zip functions |
