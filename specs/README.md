...
| [ruststack-lambda-s3-code-design](./ruststack-lambda-s3-code-design.md) | Design | Draft | S3 code packages for Lambda -- download S3Bucket/S3Key objects through an in-process bridge (S3CodeFetcher trait), same store path as ZipFile, AWS-compatible fail-fast errors, no core->core dependency |
